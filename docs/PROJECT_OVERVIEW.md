...
3. Coastal - beaches, seaside, harbors
4. Mountain - peaks, slopes, highland areas
5. Forest - wooded areas, dense vegetation

## Success Criteria
- Baseline model accuracy above 70%
- Advanced model accuracy above 85%
